document.addEventListener('DOMContentLoaded', () => {
    ...
    function showInterpretation() {
        ...
        interpText.textContent = "월간 연애운 (내면 / 관계 / 전망)\n\n" +
            "첫 번째 카드는 당신의 마음가짐과 내면의 변화를,\n" +
            "두 번째 카드는 상대방(혹은 새로운 인연)과의 관계성을,\n" +
            "세 번째 카드는 이번 달 연애의 최종적인 전망을 보여줍니다.\n" +
            "진정한 사랑을 위해 마음을 열어보세요.";
